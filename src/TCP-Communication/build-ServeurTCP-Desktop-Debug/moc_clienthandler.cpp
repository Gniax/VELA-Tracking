...
#include "../ServeurTCP/clienthandler.h"
...
QT_MOC_LITERAL(4, 33, 18), // "socketDisconnected"
QT_MOC_LITERAL(5, 52, 9), // "readyRead"
QT_MOC_LITERAL(6, 62, 19) // "processDataReceived"

    },
    "ClientHandler\0dataReceived\0\0data\0"
    "socketDisconnected\0readyRead\0"
    "processDataReceived"
};
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->processDataReceived((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientHandler::dataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientHandler::dataReceived(QString _t1)
{
